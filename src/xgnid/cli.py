...
def build_parser() -> argparse.ArgumentParser:
    ...
    train_p.add_argument("--balance-train", action="store_true", default=False)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "train":
        result = train(
            ...
            webbased_recon_sep_weight=args.webbased_recon_sep_weight,
            webbased_recon_sep_margin=args.webbased_recon_sep_margin,
